...
function main() {
  ...
  console.log('\n--- Blue Flag beaches ---')
  beaches.filter(b => b.certifications.includes('blue-flag'))
    .forEach(b => console.log(`  - ${b.name} (${b.code})`))

  console.log('\n--- Q de Calidad beaches ---')
  beaches.filter(b => b.certifications.includes('q-quality'))
    .forEach(b => console.log(`  - ${b.name} (${b.code})`))

  console.log('\n--- Ecoplayas beaches ---')
  beaches.filter(b => b.certifications.includes('ecoplayas'))
    .forEach(b => console.log(`  - ${b.name} (${b.code})`))
}
