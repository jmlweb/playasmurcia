      ...
      <ul className="space-y-3">
        {phone && (
          <li className="flex items-center gap-3">
            ...
            <a
              className="hover:text-ocean-600 focus:ring-ocean-500 rounded text-sm text-gray-700 focus:ring-2 focus:outline-none"
              href={`tel:${phone}`}
            >
              {phone}
            </a>
        ...
        {realUrl && (
          <li className="flex items-center gap-3">
            ...
            <a
              className="text-ocean-600 focus:ring-ocean-500 rounded text-sm hover:underline focus:ring-2 focus:outline-none"
              href={realUrl}
