...
describe("ActivitiesGrid", () => {
  ...
  it("renders the activities heading", () => {
    render(<ActivitiesGrid activityIndices={[0]} allActivities={mockActivities} />)
    expect(screen.getByRole("heading", { name: "Actividades" })).toBeTruthy()
  })

  it("renders the correct activities by index", () => {
    render(<ActivitiesGrid activityIndices={[1, 2]} allActivities={mockActivities} />)
  ...
  it("skips out-of-bounds indices gracefully", () => {
    render(<ActivitiesGrid activityIndices={[0, 50]} allActivities={mockActivities} />)
