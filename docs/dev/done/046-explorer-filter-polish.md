...
UI review (2026-03-28) found the mobile filter button is disconnected from the toolbar, chips lack focus states, and the clear-all button is hard to spot. See `docs/dev/ui-review/processed/explorar.md`.
...
- See `docs/dev/ui-review/processed/explorar.md` and `docs/dev/ui-review/processed/municipio-detail.md` for details
