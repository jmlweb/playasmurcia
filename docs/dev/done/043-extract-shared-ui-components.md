...
UI review (2026-03-28) found several duplicated patterns with inconsistent implementations across pages. See `docs/dev/ui-review/processed/cross-cutting.md` (CC-3, CC-5, CC-6, CC-7).
...
- See `docs/dev/ui-review/processed/cross-cutting.md` for all details
