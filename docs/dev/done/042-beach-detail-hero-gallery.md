...
UI review (2026-03-28) found the beach detail page is the only page without a hero section, creating a jarring navigation experience. The gallery also appears to show a single image. See `docs/dev/ui-review/processed/beach-detail.md` for full directive.
...
- See `docs/dev/ui-review/processed/beach-detail.md` for full design directive with specific fixes
