...
UI review (2026-03-28) found multiple elements using `focus:` instead of `focus-visible:` for ring styles, contrary to the project guidelines. See `reports/done/cross-cutting.md` (CC-2).
...
- See `reports/done/homepage.md` and `reports/done/explorar.md` for specific instances
