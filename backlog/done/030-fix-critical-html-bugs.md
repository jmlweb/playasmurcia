...
UI review (2026-03-28) found three critical rendering issues affecting multiple pages. See `reports/done/cross-cutting.md` and `reports/done/municipios-index.md` for full directives.
