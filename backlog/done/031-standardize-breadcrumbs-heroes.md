...
UI review (2026-03-28) found breadcrumbs and hero heights vary arbitrarily across pages. See `reports/done/cross-cutting.md`, `reports/done/municipality-detail.md`, and `reports/done/explorer.md` for full directives.
...
- See `reports/done/cross-cutting.md` for the recommended two-tier hero system
