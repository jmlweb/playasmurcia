...
UI review (2026-03-28) found section headings are redundant (label + heading say the same thing), sea cards lack visual differentiation from thematic cards, and accent bars could be slightly thicker. See `reports/done/colecciones-index.md`.
...
- See `reports/done/colecciones-index.md` for full directive
