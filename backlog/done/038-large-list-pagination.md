...
UI review (2026-03-28) found that Cartagena renders 69 beach cards simultaneously with no pagination. This is a performance issue on mobile (massive DOM, dozens of image requests). See `reports/done/municipality-detail.md` for full directive.
