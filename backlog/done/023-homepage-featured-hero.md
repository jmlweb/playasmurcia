...
Product parity doc ([`reports/done/github-main-feature-gap-analysis.md`](../../reports/done/github-main-feature-gap-analysis.md#home-and-hero)) described the gap: homepage should show curated featured beaches and an editorial hero instead of only dumping the full list.
