...
Product parity doc ([`reports/done/github-main-feature-gap-analysis.md`](../../reports/done/github-main-feature-gap-analysis.md#navigation)) described the gap: production uses a dropdown with municipalities and characteristics (with counts) for one-click access from any page.
