...
UI review (2026-03-28) found the municipality grid is too cramped on mobile and the hero overlay opacity may not provide sufficient contrast. See `reports/done/homepage.md`.
...
- See `reports/done/homepage.md` for full directive
