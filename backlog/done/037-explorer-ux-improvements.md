...
UI review (2026-03-28) found the explorer lacks active filter indication, uses a native browser dropdown for sort, and has other UX gaps. See `reports/done/explorer.md` for full directive.
...
- See `reports/done/explorer.md` for detailed directives
