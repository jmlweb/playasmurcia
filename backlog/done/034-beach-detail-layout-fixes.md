...
UI review (2026-03-28) found heading inconsistencies, missing card containers, and invisible UI elements. See `reports/done/beach-detail.md` for full directive.
...
- See `reports/done/beach-detail.md` for detailed fix instructions per item
