...
UI review (2026-03-28) found thematic collection cards lack visual differentiation, section headings are undersized, and empty states are inconsistent. See `reports/done/colecciones-index.md` and `reports/done/collection-detail.md` for full directives.
...
- See `reports/done/colecciones-index.md` for specific icon/color suggestions
