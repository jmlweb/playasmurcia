...
UI review (2026-03-28) found hero h1 sizes are inconsistently applied. The collection detail uses `text-4xl sm:text-5xl` (index tier) instead of `text-3xl sm:text-4xl` (detail tier). See `reports/done/cross-cutting.md` (CC-4) and `reports/done/coleccion-detail.md`.
...
- See `reports/done/coleccion-detail.md` for full directive
