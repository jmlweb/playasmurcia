...
Gap analysis (`reports/done/github-main-feature-gap-analysis.md`, section 1) identified that the production site shows current weather on each card in the grid (`WeatherBox` in `ItemsGrid`), while v3 cards only show occupancy, municipality, and tags.
