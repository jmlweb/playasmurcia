...
- [ ] Homepage beach cards show current temperature + wind indicator (see `reports/done/v3-vs-production-beach-detail.md` for production vs v3 weather UI)
- [ ] Beach detail page shows multi-day forecast with min/max temps, conditions, wind (see `reports/done/v3-vs-production-beach-detail.md`, weather section)
