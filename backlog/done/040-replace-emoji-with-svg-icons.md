...
UI review (2026-03-28) found emoji used as functional icons across multiple pages. Emoji rendering varies dramatically between macOS, Windows, Android, and Linux. ZWJ sequences (family emoji) fail on older devices. See `reports/done/cross-cutting.md` (CC-1).
...
- See `reports/done/municipios-index.md`, `reports/done/colecciones-index.md` for detailed directives
