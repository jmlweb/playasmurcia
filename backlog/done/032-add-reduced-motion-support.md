...
UI review (2026-03-28) found no `prefers-reduced-motion` handling anywhere. Multiple animations run unconditionally: hero fade-up, filter panel slide-in, card hover transforms, image zoom on hover. See `reports/done/cross-cutting.md` for full directive.
