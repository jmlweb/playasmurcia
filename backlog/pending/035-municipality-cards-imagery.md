...
UI review (2026-03-28) found municipality cards on both the index and homepage are text-only and visually flat. Service icons also render as text IDs (covered by task #030). See `reports/done/municipios-index.md` for full directive.
...
- See `reports/done/municipios-index.md` and `reports/done/municipality-detail.md` for detailed directives
