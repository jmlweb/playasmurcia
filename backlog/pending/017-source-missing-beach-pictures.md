...
See municipality counts in [`reports/done/content-audit.md`](../../reports/done/content-audit.md#1-beaches-missing-pictures-79) §1.
...
- [ ] Update `reports/done/content-audit.md` with new coverage stats
