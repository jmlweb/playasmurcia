...
- [ ] Remove or replace generic "Coleccion" hero label with descriptive category tag
- [ ] Increase beach count prominence from `text-sm text-ocean-300` to badge style
